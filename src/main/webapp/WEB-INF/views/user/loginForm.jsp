...
<body>
	<div class="container">
		<form action="/auth/procLogin" method="post" >
			...
			<a href="https://kauth.kakao.com/oauth/authorize?client_id=1a17f2259b3ddffc87c28860c51feba7&redirect_uri=http://localhost:8000/auth/kakao/callback&response_type=code"><img height="38px"src="/image/kakao_login_button.png"></a>
		</form>		
	</div>
</body>
